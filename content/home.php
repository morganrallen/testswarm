...
<p>If you feel that this may be a mistake, copy the following information (<?=$browser?> <?=$version?> <?=$os?>) and your <a href="http://useragentstring.com/">useragent string</a>, and post it to the <a href="http://groups.google.com/group/testswarm">discussion group</a>.</p>
</div>
<?php } ?>
